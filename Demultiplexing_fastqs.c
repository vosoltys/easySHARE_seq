...
void getCodei5(igzstream &I1, string &codeC,
						string& RX1, string& QX1, string& read_type1,
						int code_total_length, string code_letter2,
						map<string,string> bc2){
  ...
  //}
	...
	if(codeC.compare(code_letter2+"00")==0){
		read_type1="unclear";
	}
...
int main (int argc, char* argv[])
{
  ...
  int posName;
    ...
    getCodei5(I2,codeD,RX2,QX2,read_type2,8, "D", bc_D);
